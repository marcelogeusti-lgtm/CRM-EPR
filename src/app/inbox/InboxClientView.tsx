  ...
  return (
    <div className="flex h-full w-full">
      ...
      <div className={`flex flex-col border-r border-white/5 bg-[#050505] transition-all duration-300 ${selectedDeal ? 'w-[350px]' : 'w-[350px] max-w-[500px]'} shrink-0 relative z-20`}>
        ...
        <Link href="/integrations" className="p-5 border-b border-white/5 flex items-center gap-4 cursor-pointer hover:bg-white/[0.02] transition-colors group block">
      ...
      <div className="flex-1 bg-[#0a0a0a] relative overflow-hidden">
        {selectedDeal ? (
          ...
          <div className="h-full flex flex-col items-center justify-center relative px-6 z-10">
            ...
            <Link href="/integrations" className="group flex items-center gap-3 bg-[#111] hover:bg-[#1a1a1a] border border-white/5 hover:border-[#25D366]/50 px-5 py-3 rounded-2xl text-[14px] font-medium text-zinc-300 transition-all shadow-xl hover:shadow-[0_0_20px_rgba(37,211,102,0.15)]">
            ...
            <Link href="/integrations" className="group flex items-center gap-3 bg-[#111] hover:bg-[#1a1a1a] border border-white/5 hover:border-white/20 px-5 py-3 rounded-2xl text-[14px] font-medium text-zinc-300 transition-all shadow-xl hover:shadow-[0_0_20px_rgba(255,255,255,0.05)]">
            ...
            <Link href="/integrations" className="group flex items-center gap-3 bg-[#111] hover:bg-[#1a1a1a] border border-white/5 hover:border-[#E1306C]/50 px-5 py-3 rounded-2xl text-[14px] font-medium text-zinc-300 transition-all shadow-xl hover:shadow-[0_0_20px_rgba(225,48,108,0.15)]">
            ...
            <Link href="/integrations" className="group flex items-center gap-3 bg-[#111] hover:bg-[#1a1a1a] border border-white/5 hover:border-[#1877F2]/50 px-5 py-3 rounded-2xl text-[14px] font-medium text-zinc-300 transition-all shadow-xl hover:shadow-[0_0_20px_rgba(24,119,242,0.15)]">
